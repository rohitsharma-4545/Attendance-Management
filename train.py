...
class Train:
    ...
    def __init__(self,root):
        ...
        # background image 
        bg1=Image.open(r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\pda.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\srt.jpg")
        std_img_btn=std_img_btn.resize((180,180),Image.ANTIALIAS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.train_classifier,image=self.std_img1,cursor="hand2")
        std_b1.place(x=580,y=250,width=180,height=180)
        ...
        std_b1_1.place(x=580,y=430,width=180,height=45)
