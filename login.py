...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\woohoo.jpg")
        ...
        img1=Image.open(r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\log1.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            messagebox.showinfo("Sussessfull","Welcome to Attendance Managment System Using Facial Recognition")
        else:
            # messagebox.showerror("Error","Please Check Username or Password !")
            conn = mysql.connector.connect(host="localhost",username="root",password="DrOwSsAp@080103",database="face_recognition")
