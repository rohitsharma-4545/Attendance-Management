...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # background image 
        bg1=Image.open(r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\fr1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\det1.jpg")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            featuers=classifier.detectMultiScale(gray_image,scaleFactor=1.3,minNeighbors=5)
            ...
            for (x,y,w,h) in featuers:
                ...
                conn = mysql.connector.connect(host="localhost",username="root",password="PHW#84#jeor",database="face_recognition")
                cursor = conn.cursor()
