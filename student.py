...
class Student:
    def __init__(self,root):
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # background image 
        bg1=Image.open(r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\nice.jpg")
        ...
        dep_combo["values"]=("Select Department","Computer","Electronics","Mechanical","Civil","Chemical")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","DSA","DBMS","Physics","Chemistry","Maths")
        cou_combo.current(0)
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",user="root",password="PHW#84#jeor",database="face_recognition")
