...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Admin\OneDrive\Documents\PROJECT\PROJECT\Images_GUI\pls.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=220,y=60,width=900,height=580)
        ...
        loginbtn.place(x=350,y=530,width=270,height=35)
